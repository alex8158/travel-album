...
继续保留：R-74 ~ R-77 / R-79 / R-80 (P7)、R-82 ~ R-92 (P8)、R-93 / R-94 (P9.T1)、R-95 / R-96 / R-97 (P9.T2)、R-98 / R-99 / R-100 (P9.T3)、R-101 / R-102 / R-103 (P9.T4)、R-104 / R-105 / R-106 (P9.T5)、R-108 / R-109 (P9.T6)、R-110 / R-111 / R-112 / R-113 (P9.T7)、R-114 / R-115 / R-116 (P9.T8)、R-117 / R-118 / R-119 (P9.T9)、R-120 (P9.T10)、R-121 / R-122 (P10.T1+T2)、R-124 / R-125 / R-126 (P10.T3)、R-127 / R-128 / R-129 / R-130 (P10.T4)。R-78 / R-81 / R-107 / R-123 已闭合。

## 下一阶段入口

继续 **P10.T6 [MUST]**：前端 AI 精修按钮 —— 在 MediaDetailPage 加入 "AI Refine" 按钮，置灰 + tooltip 表达 "AI 未配置" 状态 (通过 `GET /api/health` 或 `aiProvider.available` 投影到客户端)，按下时弹耗时 / 成本提示对话框，确认后 POST `/api/media/:id/ai-refine`。enqueue 后展示 jobId + outcome；P10.T5 worker 写完 `media_versions(version_type='ai_refined')` 后，用户在 P8.T5 既有的版本对比面板里看到新 'ai_refined' tab。注意：P10.T6 不实现服务端 endpoint（P10.T3 已提供）、不写 worker（P10.T5 已落地）；仅前端层。还需注意：501 + AI_NOT_CONFIGURED / 429 + AI_QUOTA_EXCEEDED 的错误 body 要给清晰 UI 展示（参考 R-125 + 429 details.kind/limit/used 已在 body 中提供）。
