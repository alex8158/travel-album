...
- [ ] **P6.T7 [MUST]** 启用自动最佳封面选择
  ...
  - 自动选择应在质量评分完成后异步触发（例如新增 `trip_cover_refresh` 任务），避免阻塞主流程；P3.T6 的响应层临时封面在 `cover_media_id` 写入后自动失效。
...
| §7.13 视频优化 | P11.T1 |
| §7.14 智能剪辑 | P11.T2–T4 |
| §7.15 相册展示 | P1.T6 / P2.T7 / P3.T4 / P5.T6 |
| §7.16 封面 | P6.T7 |
| §7.17 任务状态 | P4.* |
| §7.18 删除/恢复 | P7.* |
